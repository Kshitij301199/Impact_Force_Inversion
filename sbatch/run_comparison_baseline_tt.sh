...
# # Second pair
jid2=$(sbatch --constraint=grid-redundant ./cb_traintest/train_lstm.sh | awk '{print $4}')
sbatch --constraint=grid-redundant --dependency=afterok:$jid2 ./cb_traintest/train_lstm_single.sh

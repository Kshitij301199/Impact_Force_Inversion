...
#SBATCH --array=1-33%4            # job array id, adjusted for the total number of commands (stations * juldays * intervals)
...
#SBATCH --output=./logs/out/t21_%A_%a.txt   # Standard Output Log File (for Job Arrays)
#SBATCH --error=./logs/err/t21_%A_%a.txt    # Standard Error Log File (for Job Arrays)
...
component="EHZ"
year=2021
julday_list=(131 136 142 156 173 175 187 194 197 219 262)
intervals=(5 15 30)
models=('xLSTM')

...
#SBATCH --array=1-32%4            # job array id, adjusted for the total number of commands (stations * juldays * intervals)
...
#SBATCH --output=./logs/out/t20_%A_%a.txt   # Standard Output Log File (for Job Arrays)
#SBATCH --error=./logs/err/t20_%A_%a.txt    # Standard Error Log File (for Job Arrays)
...
component="EHZ"
year=2020
julday_list=(156 159 160 169 181 229 230 243)
intervals=(5 10)
models=('xLSTM' 'LSTM')

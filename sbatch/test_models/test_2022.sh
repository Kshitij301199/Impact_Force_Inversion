...
#SBATCH --array=1-24%2            # job array id, adjusted for the total number of commands (stations * juldays * intervals)
...
#SBATCH --output=./logs/out/t22_%A_%a.txt   # Standard Output Log File (for Job Arrays)
#SBATCH --error=./logs/err/t22_%A_%a.txt    # Standard Error Log File (for Job Arrays)

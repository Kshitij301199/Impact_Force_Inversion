...
#SBATCH --array=1-32%2            # job array id, adjusted for the total number of commands (stations * juldays * intervals)
...
#SBATCH --output=./logs/out/t23_%A_%a.txt   # Standard Output Log File (for Job Arrays)
#SBATCH --error=./logs/err/t23_%A_%a.txt    # Standard Error Log File (for Job Arrays)

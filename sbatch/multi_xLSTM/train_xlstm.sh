...
#SBATCH --job-name=mul_xlstm           # job name
...
#SBATCH --output=./logs/out/mul_xlstm_out_%A_%a.txt   # Standard Output Log File (for Job Arrays)
#SBATCH --error=./logs/err/mul_xlstm_err_%A_%a.txt    # Standard Error Log File (for Job Arrays)
